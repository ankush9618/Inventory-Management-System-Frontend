...
function Products() {
  ...
  return (
    <>
    {
      loggedIn?(!loading?<div className="bg-gradient-to-tr from-white via-zinc-400 to-gray-400 py-16 px-16 min-h-screen">
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-4 md:gap-8">{products.map((product)=><div key={product._id}><ProductCard product={product}/></div>)}</div></div></div>:<div className="bg-gradient-to-tr from-white via-zinc-400 to-gray-400 py-16 px-16 w-full min-h-screen"><Loader/></div>):<div className='bg-gradient-to-tr from-white via-zinc-400 to-gray-400 min-h-screen py-16 px-16'>
