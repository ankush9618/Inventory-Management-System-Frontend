  ...
  return (
    ...
    <div className="md:py-16 md:px-8 min-h-screen">
      <div className="container mx-auto px-4">
          ...
          <div className='md:text-xl flex justify-center items-center gap-2 font-semibold bg-gray-900 px-3 py-1 rounded-full pr-4 dark:bg-white dark:text-gray-900 cursor-pointer' onClick={()=>setRefresh(!refresh)}>Refresh</div>
          </div>
