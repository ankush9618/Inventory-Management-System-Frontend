          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#" onSubmit={signupHandler}>
                <div>
                      ...
                      <input type="text" name="name" id="confirm-password" placeholder="Ankush Kumar Singh" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                  </div>
                  <div>
                  ...
                  <div className='flex justify-start items-center gap-4'>
                      <label for="role" className="block  text-sm font-medium text-gray-900 dark:text-white">Role</label>
                      <select name="role" id="role" className='p-1 text-white dark:bg-gray-700 bg-gray-50 border border-gray-300 dark:border-gray-600 dark:placeholder-gray-400 rounded-md'>
